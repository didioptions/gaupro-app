...
export const allProfessionals: ProfessionalsByCategory = {
  ...
  "aluminium-doors-and-windows": [
    ...
    },
    {
      ...
      "reviewData": [
        ...
        { "author": "Fatima H.", "rating": 5, "comment": "The installation was quick and the quality is excellent." },
  ...
  "blinds": [
    {
        "id": "pro-blind-1",
        "name": "Jozi Blinds & Shutters",
        "location": "Sandton, Johannesburg",
        "description": "Premier suppliers of custom-made window blinds and plantation shutters in Johannesburg. We offer a wide range of Venetian, Roller, and Vertical blinds in various materials including wood, aluminium, and fabric. Our expert team provides professional measurement and installation services for both residential and corporate offices across Gauteng.",
        "rating": 4.9,
        "reviews": 32,
        ...
        "yearsInBusiness": 11,
        "employees": 14,
        "services": ["Roller Blinds", "Venetian Blinds", "Plantation Shutters", "Custom Installation"],
        "reviewData": [
            { "author": "Amy S.", "rating": 5, "comment": "Beautiful roller blinds! They fit perfectly and look amazing." },
            { "author": "Lerato K.", "rating": 5, "comment": "Professional service from measurement to the final install." },
            { "author": "Mark D.", "rating": 4, "comment": "Great quality wood blinds, very happy with the finish." },
            { "author": "Sarah G.", "rating": 5, "comment": "Fast turnaround and excellent prices for the Sandton area." }
        ]
    },
    {
        "id": "pro-blind-2",
        "name": "Pretoria Window Styles",
        "location": "Pretoria East, Pretoria",
        "description": "Leading window covering specialists in Pretoria. We specialize in motorized blinds and energy-efficient cellular shades. Our products are designed to control light and temperature, perfect for the South African climate. We provide high-quality Roman blinds and Bamboo shades that add a touch of elegance to any Pretoria home.",
        "rating": 4.7,
        "reviews": 25,
        ...
        "yearsInBusiness": 8,
        "employees": 10,
        "services": ["Motorized Blinds", "Cellular Shades", "Roman Blinds", "Bamboo Blinds"],
        "reviewData": [
            { "author": "Johan V.", "rating": 5, "comment": "The motorized blinds are a game changer. Excellent quality." },
            { "author": "Mpho K.", "rating": 4, "comment": "Very helpful staff and a great selection of fabrics." },
            { "author": "Annatjie S.", "rating": 5, "comment": "Beautiful Roman blinds, they really finished off my lounge." },
            { "author": "David B.", "rating": 5, "comment": "Reliable service and very professional installation team." }
        ]
    },
    {
        "id": "pro-blind-3",
        "name": "Sandton Shading Co.",
        "location": "Sandton, Johannesburg",
        "description": "Luxury window shading solutions for high-end residential and commercial properties in Sandton. We focus on premium automated systems and designer fabrics. Our range includes blockout blinds for bedrooms and sheer-weave blinds for office environments, combining functionality with sophisticated modern design.",
        "rating": 4.8,
        "reviews": 18,
        ...
        "yearsInBusiness": 6,
        "employees": 9,
        "services": ["Automated Shading", "Blockout Blinds", "Office Blinds", "Sheer Weave Blinds"],
        "reviewData": [
            { "author": "Bradley W.", "rating": 5, "comment": "Top-tier service. The automated blinds are perfect." },
            { "author": "Jessica R.", "rating": 5, "comment": "The blockout blinds are exactly what we needed for the nursery." },
            { "author": "Thabo N.", "rating": 4, "comment": "Expensive but worth it for the quality and style." },
            { "author": "Simon V.", "rating": 5, "comment": "Professional team and very high-quality finish." }
        ]
    },
    {
        "id": "pro-blind-4",
        "name": "East Rand Blinds Direct",
        "location": "Boksburg, Ekurhuleni",
        "description": "Affordable and reliable blind installations across the East Rand. We offer a direct-to-public service on PVC Venetian blinds, fabric vertical blinds, and outdoor roller blinds. Our mission is to provide quality window coverings at budget-friendly prices with a quick 7-day turnaround time.",
        "rating": 4.6,
        "reviews": 41,
        ...
        "yearsInBusiness": 10,
        "employees": 12,
        "services": ["PVC Venetian Blinds", "Vertical Blinds", "Outdoor Blinds", "Budget Solutions"],
        "reviewData": [
            { "author": "Kevin L.", "rating": 5, "comment": "Great prices and very fast service. Highly recommend." },
            { "author": "Nadine D.", "rating": 4, "comment": "The vertical blinds look great in my office." },
            { "author": "Sizwe Z.", "rating": 5, "comment": "Reliable guys, they did exactly what they promised." },
    ...
    {
        "id": "pro-blind-5",
        "name": "Centurion Blind Specialists",
        "location": "Centurion, Pretoria",
        "description": "Dedicated blind and shutter experts serving the Centurion area. We specialize in moisture-resistant Faux Wood blinds, ideal for bathrooms and kitchens. Our team offers a free home consultation service to help you choose the right style and color to match your interior decor.",
        "rating": 4.5,
        "reviews": 29,
        ...
        "yearsInBusiness": 7,
        "employees": 8,
        "services": ["Faux Wood Blinds", "Kitchen Blinds", "Bathroom Blinds", "In-Home Consultation"],
        "reviewData": [
            { "author": "Willem D.", "rating": 5, "comment": "The faux wood blinds in the bathroom look perfect." },
            { "author": "Nomsa L.", "rating": 4, "comment": "Good service and the team was very friendly." },
            { "author": "Henk S.", "rating": 5, "comment": "Best value for money in Centurion for blinds." },
            { "author": "Teboho M.", "rating": 4, "comment": "Quality workmanship and professional install." }
        ]
    },
    {
        "id": "pro-blind-6",
        "name": "West Rand Window Coverings",
        "location": "Roodepoort, Johannesburg",
        "description": "Family-run business providing custom blinds and window tints in the West Rand. We offer a massive range of fabric choices for our roller and vertical blind collections. We pride ourselves on personalized service and attention to detail, ensuring every window is perfectly fitted.",
        "rating": 4.9,
        "reviews": 35,
        ...
        "yearsInBusiness": 13,
        "employees": 6,
        "services": ["Fabric Roller Blinds", "Vertical Blinds", "Window Tinting", "Custom Fitting"],
        "reviewData": [
            { "author": "Charmaine B.", "rating": 5, "comment": "Wonderful service! The fabric blinds are beautiful." },
            { "author": "Andries P.", "rating": 5, "comment": "Very happy with the tints and the blinds. 5 stars." },
    ...
    {
        "id": "pro-blind-7",
        "name": "Midrand Modern Blinds",
        "location": "Midrand, Johannesburg",
        "description": "Specializing in modern window treatments for the fast-growing Midrand and Waterfall areas. We offer high-tech motorized systems and 'Smart Blinds' that can be controlled via smartphone. Our focus is on contemporary styles like Vision (Zebra) blinds and sleek aluminium Venetians.",
        "rating": 4.7,
        "reviews": 21,
        ...
        "yearsInBusiness": 5,
        "employees": 11,
        "services": ["Vision (Zebra) Blinds", "Smart Blinds", "Aluminium Venetians", "Motorized Systems"],
        "reviewData": [
            { "author": "Zanele T.", "rating": 5, "comment": "The Zebra blinds look amazing in our new house." },
            { "author": "Chris J.", "rating": 5, "comment": "The smart integration works perfectly with our home system." },
            { "author": "Musa W.", "rating": 4, "comment": "Excellent technical knowledge and professional team." },
            { "author": "Claire V.", "rating": 5, "comment": "Fast and efficient service in Kyalami." }
        ]
    },
    {
        "id": "pro-blind-8",
        "name": "Egoli Roller Blinds",
        "location": "Linden, Johannesburg",
        "description": "Dedicated roller blind specialists in the heart of Johannesburg. We offer a curated collection of local and imported fabrics, from blackout to sun-filtering textures. We cater specifically to the trendy suburbs of Jozi, providing stylish and practical window solutions for homes and studios.",
        "rating": 4.4,
        "reviews": 15,
        ...
        "yearsInBusiness": 9,
        "employees": 7,
        "services": ["Designer Roller Blinds", "Blackout Shades", "Sun-Filtering Blinds", "Studio Blinds"],
        "reviewData": [
            { "author": "Zanele M.", "rating": 5, "comment": "Love my new roller blinds! The fabric is so high quality." },
            { "author": "Mark D.", "rating": 4, "comment": "Good service and they have a great eye for design." },
            { "author": "Claire S.", "rating": 5, "comment": "The sun-filtering blinds are perfect for my art studio." },
            { "author": "Robert M.", "rating": 4, "comment": "Reliable and the installation was very quick." }
        ]
    },
    {
        "id": "pro-blind-9",
        "name": "Vaal Decor Blinds",
        "location": "Vereeniging, Gauteng",
        "description": "Providing the Vaal Triangle with affordable and stylish window decor. We offer a full range of blinds, including durable outdoor patio blinds and classic interior Venetians. We are known for our friendly service and for being the go-to supplier for large residential projects in the Vaal area.",
        "rating": 4.3,
        "reviews": 48,
        ...
        "yearsInBusiness": 15,
        "employees": 15,
        "services": ["Patio Blinds", "Venetian Blinds", "Residential Projects", "Full-House Packages"],
        "reviewData": [
            { "author": "Ockert V.", "rating": 5, "comment": "Excellent service and a very sturdy product." },
            { "author": "Maria M.", "rating": 4, "comment": "The team was very helpful and the price was right." },
            { "author": "Thabo K.", "rating": 4, "comment": "Good quality blinds and professional installation." },
            { "author": "Petrus S.", "rating": 4, "comment": "Happy with the result. Great for the patio." }
        ]
    },
    {
        "id": "pro-blind-10",
        "name": "Azizi Blind & Tint",
        "location": "Alberton, Ekurhuleni",
        ...
        "reviewData": [
            { "author": "Sonia P.", "rating": 5, "comment": "The combination of tints and blinds made a huge difference." },
            { "author": "Jason K.", "rating": 5, "comment": "Best prices in Alberton. Very professional." },
            { "author": "Fatima H.", "rating": 5, "comment": "The installation was quick and the quality is excellent." },
            { "author": "Neil O.", "rating": 5, "comment": "Top class service from a very local team." }
        ]
    }
  ],
  "burglar-bars": [
    ...
    },
    {
        ...
        "reviewData": [
            ...
            { "author": "Jessica R.", "rating": 5, "comment": "High-end service for a high-end home. Very professional." },
            { "author": "Simon V.", "rating": 4, "comment": "Premium pricing but the quality is unmatched." },
            { "author": "Nthabiseng M.", "rating": 5, "comment": "Clean, modern, and very safe." }
        ]
    },
    {
