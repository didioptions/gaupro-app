...
const testimonials = [
  {
    ...
    avatarUrl: "https://firebasestorage.googleapis.com/v0/b/studio-5618869838-18486.firebasestorage.app/o/real_sara_with_bgc.png?alt=media&token=3d7ed5c8-ec42-4695-9540-6b3f2e2c490b",
    avatarSeed: "sarah-l",
  },
  {
  ...
  return (
    <section id="testimonials" className="py-20 md:py-24">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-normal text-center mb-12 font-headline">Loved by Homeowners Everywhere</h2>
        <Carousel
          opts={{
            align: "start",
            loop: true,
