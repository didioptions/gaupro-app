             ...
             <div className="relative container mx-auto px-4 grid md:grid-cols-2 items-center gap-8 text-left">
                <div className="hidden md:block">
                  ...
                  <p className="mt-4 text-lg text-white/90">
                      Professional and ethical debt recovery services for your business.
                  </p>
                </div>
        ...
        <section className="py-16 bg-background">
          <div className="container mx-auto px-4">
            <div className="text-left mb-8">
                ...
                <h2 className="text-3xl mt-1">Top 5 Debt Collection Agencies in Gauteng</h2>
            </div>
                ...
                <aside className="space-y-8">
                    <div className="p-6 border rounded-lg bg-card">
                        ...
                        <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1">
                            <li>{pros.reduce((acc, pro) => acc + pro.reviews, 0)}+ Reviews for debt collection</li>
                            <li>{pros.filter(p => p.rating >= 4).length * 15}+ Positive Reviews</li>
                            <li>Recently hired agencies have been rated 4.8/5 stars by clients</li>
                            <li>View Top Debt Collectors today</li>
                        </ul>
                    </div>
                     <div className="p-6 border rounded-lg bg-card">
