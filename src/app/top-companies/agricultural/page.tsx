...
export default function TopAgriculturalPage() {
  const proCategory = 'agricultural';
         ...
         <section className="relative min-h-[500px] flex items-center justify-center text-center text-white">
            {heroImage && (
                <Image
                    ...
                    alt={heroImage.description || "Agricultural service background"}
                    fill
             ...
             <div className="relative container mx-auto px-4 grid md:grid-cols-2 items-center gap-8 text-left">
                <div className="hidden md:block">
                  ...
                  <p className="mt-4 text-lg text-white/90">
                      Find experts in farming, equipment, and agricultural solutions.
                  </p>
                </div>
            ...
            <div className="grid lg:grid-cols-3 gap-12">
                ...
                <aside className="space-y-8">
                    <div className="p-6 border rounded-lg bg-card">
                        <h3 className="mb-3 font-semibold text-foreground">Need Agricultural Support?</h3>
