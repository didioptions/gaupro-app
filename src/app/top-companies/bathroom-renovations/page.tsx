            ...
            {heroImage && (
             ...
             <div className="relative container mx-auto px-4 grid md:grid-cols-2 items-center gap-8 text-left">
                <div className="hidden md:block">
                  <h1 className="text-4xl md:text-5xl font-normal">Bathroom Renovation Companies</h1>
                  <p className="mt-4 text-lg text-white/90">
                      Get matched with top-rated, verified professionals in your area.
                  </p>
                </div>
                <InlineQuoteForm service="bathroom-renovations" location="South Africa" />
             </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="text-left mb-8">
                <div className="flex items-center gap-1 text-sm text-muted-foreground">
                    ...
                    <span className="font-medium text-foreground">Top Bathroom Renovation Companies</span>
                </div>
                <h2 className="text-3xl mt-1">Top 7 Bathroom Renovation Companies</h2>
            </div>
            <div className="grid lg:grid-cols-3 gap-12">
                <div className="lg:col-span-2 space-y-6">
                    {topCompanies.map((pro) => (
                        <ProfessionalCard key={pro.id} professional={pro} service="bathroom-renovations" />
                    ))}
                </div>
                <aside className="space-y-8">
                    <div className="p-6 border rounded-lg bg-card">
                        <h3 className="mb-3 font-semibold text-foreground">Need Bathroom Renovation Services?</h3>
                        <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1">
                            <li>350+ Reviews for bathroom renovations</li>
                            <li>320 Positive Reviews</li>
                            <li>Recently hired Pros have been rated 4.9/5 stars by customers</li>
                            <li>View Top Bathroom Renovation Pros today</li>
                        </ul>
                    </div>
                     <div className="p-6 border rounded-lg bg-card">
                    ...
                    <div className="p-6 border rounded-lg bg-card text-center">
                      ...
                      <a href="/post-request?service=bathroom-renovations" className="inline-flex items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-primary text-primary-foreground hover:bg-primary/90 h-10 px-4 py-2">
                        Get Free Quotes
                      </a>
                    </div>
                </aside>
