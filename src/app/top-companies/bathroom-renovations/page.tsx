...
export default function TopBathroomRenovationsPage() {
  const proCategory = 'bathroom-renovations';
         ...
         <section className="relative min-h-[500px] flex items-center justify-center text-center text-white">
            {heroImage && (
                <Image
                    ...
                    alt={heroImage.description || "Bathroom renovation service background"}
                    fill
             ...
             <div className="relative container mx-auto px-4 grid md:grid-cols-2 items-center gap-8 text-left">
                <div className="hidden md:block">
                  <h1 className="text-4xl md:text-5xl font-normal">Top Bathroom Renovation Companies</h1>
                  <p className="mt-4 text-lg text-white/90">
                      Create your dream bathroom with top-rated renovation specialists.
                  </p>
                </div>
        ...
        <section className="py-16 bg-background">
          <div className="container mx-auto px-4">
            <div className="text-left mb-8">
                ...
                <h2 className="text-3xl mt-1">Top 5 Bathroom Renovation Companies in Gauteng</h2>
            </div>
            <div className="grid lg:grid-cols-3 gap-12">
                ...
                <aside className="space-y-8">
                    <div className="p-6 border rounded-lg bg-card">
                        <h3 className="mb-3 font-semibold text-foreground">Planning a Bathroom Reno?</h3>
                        <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1">
                            <li>{pros.reduce((acc, pro) => acc + pro.reviews, 0)}+ Reviews for bathroom renovations</li>
                            ...
                            <li>View Top Bathroom Renovation Companies today</li>
                        </ul>
                    </div>
                     <div className="p-6 border rounded-lg bg-card">
