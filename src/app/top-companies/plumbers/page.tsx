      ...
      return (
        <Card>
          <CardContent className="p-6 text-center">
            <p className="text-lg text-muted-foreground">No top plumbers found.</p>
          </CardContent>
        </Card>
      );
    }
         ...
         <section className="relative min-h-[500px] flex items-center justify-center text-center text-white">
            {heroImage && (
                <Image
                    ...
                    alt={heroImage.description || "Plumbing service background"}
                    fill
             ...
             <div className="relative container mx-auto px-4 grid md:grid-cols-2 items-center gap-8 text-left">
                <div className="hidden md:block">
                  <h1 className="text-4xl md:text-5xl font-normal">Top Plumbing Companies</h1>
                  <p className="mt-4 text-lg text-white/90">
                      24/7 emergency plumbers for blocked drains, burst geysers, and leak detection.
                  </p>
                </div>
          ...
          <div className="container mx-auto px-4">
            <div className="text-left mb-8">
                <div className="flex items-center gap-1 text-sm text-muted-foreground">
                    ...
                    <span className="font-medium text-foreground">Top Plumbing Companies</span>
                </div>
                <h2 className="text-3xl mt-1">Top 6 Plumbing Companies</h2>
            </div>
                ...
                <aside className="space-y-8">
                    <div className="p-6 border rounded-lg bg-card">
                        ...
                        <ul className="list-disc list-inside text-sm text-muted-foreground space-y-1">
                            <li>View top rated plumbers today</li>
                        </ul>
                    </div>
                     <div className="p-6 border rounded-lg bg-card">
