          ...
          <div className="max-w-3xl mx-auto">
            ...
            <div className="space-y-8 text-foreground">
              ...
              <section className="space-y-4">
                <h2 className="text-2xl text-foreground">1. About Gaupro</h2>
              ...
              <section className="space-y-4">
                <h2 className="text-2xl text-foreground">2. Using Gaupro</h2>
              ...
              <section className="space-y-4">
                <h2 className="text-2xl text-foreground">3. For Professionals (“Pros”)</h2>
              ...
              <section className="space-y-4">
                <h2 className="text-2xl text-foreground">4. Payments and Refunds</h2>
              ...
              <section className="space-y-4">
                <h2 className="text-2xl text-foreground">5. Account Termination</h2>
              ...
              <section className="space-y-4">
                <h2 className="text-2xl text-foreground">6. User Content and Reviews</h2>
              ...
              <section className="space-y-4">
                <h2 className="text-2xl text-foreground">8. Privacy and Communication</h2>
              ...
              <section className="space-y-4">
                <h2 className="text-2xl text-foreground">9. Dispute Resolution</h2>
              ...
              <section className="space-y-4">
                <h2 className="text-2xl text-foreground">10. Legal Jurisdiction</h2>
