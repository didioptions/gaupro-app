...
export default function ContactPage() {
  ...
  function onSubmit(values: z.infer<typeof contactFormSchema>) {
    toast({
        title: 'Message Sent',
        description: "Thank you for contacting Gaupro. Our team will get back to you shortly.",
    });
    form.reset();
  }
    ...
    <main className="flex-grow bg-background">
      <section className="relative min-h-[400px] flex items-center justify-center text-center text-white">
        ...
        <div className="relative container mx-auto px-4 py-16">
          <h1 className="text-3xl md:text-5xl font-extrabold text-white">We’re Here to Help</h1>
        ...
        <div className="max-w-5xl mx-auto space-y-16">
          ...
          <section className="grid md:grid-cols-2 gap-12 items-start">
              <div>
                  ...
                  <div className="mt-10">
                      <h3 className="text-xl font-bold mb-4 text-foreground">Support For</h3>
                      <div className="grid grid-cols-2 gap-4">
                          <Card className="p-4">
                              <User className="h-6 w-6 text-primary mb-2" />
                              <h4 className="font-semibold text-foreground">Customers</h4>
           ...
           <section className="text-center border-t pt-16">
              ...
              <div className="flex justify-center gap-6 mb-8">
               ...
               <div className="flex items-center justify-center gap-4 p-6 bg-secondary/50 rounded-lg">
                  ...
                  <div>
                      <h3 className="text-xl font-semibold text-foreground">Check our Help Center</h3>
