      ...
      <main className="flex-grow bg-background">
        <div className="container mx-auto px-4 py-12 md:py-16">
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <section className="space-y-4 text-center p-8 bg-secondary/50 rounded-lg">
                ...
                <ul className="list-inside space-y-2 text-muted-foreground text-left md:text-center max-w-xl mx-auto">
            ...
            <section className="space-y-4">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                 ...
                 <p className="text-center text-muted-foreground italic pt-4">No more endless searching. No unreliable classifieds. No middlemen. Just direct connections between customers and verified professionals.</p>
            </section>
