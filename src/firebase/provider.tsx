...
export const FirebaseProvider: React.FC<FirebaseProviderProps> = ({
  ...
  const contextValue = useMemo((): FirebaseContextState => {
    ...
    return {
      ...
      // **THE FIX**: Only provide the firestore instance if auth state is resolved.
      firestore: servicesAvailable && isAuthReady ? firestore : null,
 ...
 * Returns null for services if they are not yet available.
 */
export const useFirebase = (): FirebaseServicesAndUser => {
  const context = useContext(FirebaseContext);

  if (context === undefined) {
    // This can happen during the initial render on the client before context is available.
